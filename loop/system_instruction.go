...
func buildAgentSystemInstruction(request AgentTurnRequest) string {
	...
	instruction += " When an image is in front of you, write what it shows into executionStateUpdate.knownFacts on that same call, in enough detail to work from later. The image is shown once; the note is what you will still have."
